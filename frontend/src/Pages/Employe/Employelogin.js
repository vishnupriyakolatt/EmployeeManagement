...
const navigate=useNavigate()
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const result = await axios.post('http://localhost:7000/admin/emplogin', values);
      console.log(result); 
navigate('/')
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] lg:max-w-xl">
        <img src="https://okcredit-blog-images-prod.storage.googleapis.com/2021/02/b2--1--3.jpg" className="w-60 h-60 mx-auto" alt="Logo" />
